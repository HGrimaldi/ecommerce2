...
class DireccionesSearch extends Direcciones
{
    ...
    {
        return [
            [['id_direccion', 'id_cliente', 'id_municipio', 'id_departamento', 'principal', 'id_usuario_ing', 'id_usuario_mod', 'estado'], 'integer'],
            [['contacto', 'teléfono', 'direcion', 'fecha_ing', 'fecha_mod'], 'safe'],
        ];
    }
